			...
			<div class="row">
				<div class="col-xl-9 col-lg-10 col-md-11 mx-auto">
					...
					<?php foreach($songs as $row) { ?>
						<?php //$no++; if($no==4) break; ?>
						<a href="#">
							<div class="single_music_item">
								<div class="image_box">
									<?php if ($row->picture != ""){
									$picture = explode("|" , $row->picture); ?>
									<img class="img-fluid" src="<?php if (strpos($picture[1], 'http') !== false) echo $picture[1]; else echo base_url().'assets/img/'.$picture[1]; ?>" alt="<?php echo $picture[0]; ?>">
									<?php } else { ?>
